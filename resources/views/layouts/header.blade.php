    ...
    <div class="flex items-center">
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            ...
            <div x-cloak x-show="dropdownOpen" class="absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl">
                <a href="{{route('profile.edit')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">{{ __('Perfil') }} </a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-dropdown-link class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white" :href="route('logout')"
